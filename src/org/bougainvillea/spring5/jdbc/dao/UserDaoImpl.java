...
public class UserDaoImpl implements UserDao {
    ...
    public User select(int id) {
        ...
        Object[] args={id};
        System.out.println(jdbcTemplate.queryForObject(sql,args, Integer.class));
    ...
    public User select2(int id) {
        String sql2="select * from spring5_user where id=?";
        Object[] args={id};
        return jdbcTemplate.queryForObject(sql2, args, new BeanPropertyRowMapper<>(User.class));
    }
