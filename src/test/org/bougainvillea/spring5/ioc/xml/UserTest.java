package test.org.bougainvillea.spring5.ioc.xml;

import org.bougainvillea.spring5.ioc.xml.User;
...
public class UserTest {
    ...
    public void testAdd(){
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("source/ioc/xml/userBean.xml");
...
//        BeanFactory context = new ClassPathXmlApplicationContext("source/ioc/userServiceBean.xml");
    ...
    public void testUserBean1(){
        ApplicationContext context = new ClassPathXmlApplicationContext("source/ioc/xml/userBean1.xml");
        User user = context.getBean("user",User.class);
        user.add();
    }
